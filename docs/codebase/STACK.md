...
| Module/build system | POSIX Shell modular sourcing (`scripts/lib/worlds.sh`), Typst (`0.15.1`), and Pandoc (`3.1.x`/`2.19.x`) | [`scripts/lib/worlds.sh`](file:///scripts/lib/worlds.sh#L1-L20), [`scripts/export_book.sh`](file:///scripts/export_book.sh#L1-L30), [`templates/typst/book_template.typ`](file:///templates/typst/book_template.typ#L1-L20) |
